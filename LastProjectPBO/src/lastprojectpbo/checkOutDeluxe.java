...
public class checkOutDeluxe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        kamarTersedia.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Kamar yang ada di Deluxe:", "Kamar 01", "Kamar 02", " ", " " }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(namaBooking.getText().isEmpty() && alamatBooking.getText().isEmpty() && noTelpBooking.getText().isEmpty() && tglCheckIn.getDate() == null && tglCheckOut.getDate() == null && kamarTersedia.getSelectedIndex() == -1){
            ...
            try{
                ...
                String query = "INSERT INTO booking (room_id, nama, alamat, no_Telpon, tgl_CheckIn, tgl_CheckOut) values (?, ?, ?, ?, ?, ?)";

                try (PreparedStatement ps = conn.prepareStatement(query)) {
                    ps.setString(1, kamarTersedia.getSelectedItem().toString());
                    ps.setString(3, alamatBooking.getText());
                    ps.setString(4, noTelpBooking.getText());
                    ps.setDate(5, new java.sql.Date(checkIn.getTime()));
                    ps.setDate(6, new java.sql.Date(checkOut.getTime()));
                    ps.setString(2, namaBooking.getText());
                    ps.executeUpdate();
